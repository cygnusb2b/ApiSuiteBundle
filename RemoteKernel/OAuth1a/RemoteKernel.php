<?php
namespace Cygnus\ApiSuiteBundle\RemoteKernel\OAuth1a;
...
class RemoteKernel implements RemoteKernelInterface
{
     ...
     *
     * @var Cygnus\ApiSuiteBundle\RemoteKernel\OAuth1a\Config
     */
    protected $config;
     ...
     *
     * @var Cygnus\ApiSuiteBundle\RemoteKernel\OAuth1a\Token
     */
    ...
    /**
     * Proxy to Cygnus\ApiSuiteBundle\ApiClient\OAuth1a\Config methods.
     *
     * @param  string $method
     * @param  array  $args
     * @return mixed
     * @throws Exception If method does not exist in Cygnus\ApiSuiteBundle\ApiClient\OAuth1a\Config
     */
